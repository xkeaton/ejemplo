...
Q.Sprite.extend("Rex",{
  ...
  checkFrontBox: function(){
    ...
    if((box.p.x - this.p.x) > 100){//no esta cerca
      this.moveProperties.isInTheFront = false;
      return false;
    }
    this.moveProperties.event = "";
    this.moveProperties.isInTheFront = true;
    return true;
  },
  idleEvent: function(){
    this.moveProperties.event = "";
...
Q.scene("level3",function(stage) {
  ...
  stage.insert(new Q.Repeater({ asset: "coinGold.png",
    ...
    */
    ...
    box = new Q.Box();
    stage.insert(box);
    stage.insert(new Q.Coin({ repeatY: false, repeatX: false, x: 450, y: 350 }));
    rex = new Q.Rex();
    stage.insert(rex);
